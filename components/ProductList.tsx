...
const ProductList: React.FC<ProductListProps> = ({ products, isLoading, onSelectProduct, onRefresh }) => {
  return (
    <div className="bg-gray-800 rounded-xl p-6 shadow-2xl border border-gray-700 h-full flex flex-col">
        <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-indigo-300">Find Your Next Flip</h2>
            <button 
                onClick={onRefresh}
                disabled={isLoading}
